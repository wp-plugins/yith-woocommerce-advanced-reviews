	...
	<div class="reviews_bar">
		...
		<?php for ( $i = 0; $i < 5; $i ++ ) :
			...
			<div class="ywar_review_row">
				...
				<span class="ywar_stars_value"><?php printf( _n( '%s star', '%s stars', $stars, 'ywar' ), $stars ); ?></span>
				<span class="ywar_num_reviews"><?php echo $review_stats[ $stars ]; ?></span>
				<span class="ywar_rating_bar">
					<?php $perc = ${"review" . $stars . "_perc"}; ?>
					<span style="background-color:<?php echo get_option( 'ywar_summary_bar_color' ); ?>" class="ywar_scala_rating">
						<span class="ywar_perc_rating" style="width: <?php echo $perc; ?>%; background-color:<?php echo get_option( 'ywar_summary_percentage_bar_color' ); ?>">
							...
							<span class="ywar_perc_value"><?php printf( '%s %%', $perc ); ?></span>
							<?php endif; ?>
						</span>
					</span>
				</span>
