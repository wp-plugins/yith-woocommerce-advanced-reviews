		...
		public function add_reviews_average_info( $product ) {
			...
			if ( $count > 0 ) {
				echo '<div class="woocommerce-product-rating">
                    ...
                    <a href="#reviews" class="ywar_filter_reviews" data-id_product="' . $product->id . '" data-stars="0" rel="nofollow"><span>' . $count . '</span>' . _n( " review", " reviews", $count, 'ywar' ) . ' </a><span class="review-rating-value"> ' . esc_html( $average ) . ' ' . __( "out of 5 stars", 'ywar' ) . '</span>
                </div>';
			}
		}
